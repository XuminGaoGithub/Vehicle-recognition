...
{
	//cout << "test1" << endl;
	extern float Ix[200][200], Ied[200][200], Iphase[200][200];
	extern float Iy[200][200];// Ied[500][500], Iphase[500][500];
	extern float img[200][200];
	extern float Cell[9][1000][1000];
	extern float tmpx[26][26], tmped[26][26], tmpphase[26][26], f[9], sum1;
	extern float imginput[110][110];
	sum1 = 0;
	//cout << "test2" << endl;
...
void slidewindow(int loop)
{
	...
	extern int M;
	extern int N;
        extern float part1schp[4];
extern float part2schp[4];
extern float part3schp[4];
extern int partloop;
...
cout<<"ii:"<<ii<<"jj:"<<jj<<endl;
	...
	ofstream fout;
	fout.open("data/Featureout.data");
	...
	int label = 1;
	ofstream foutlabel;
	foutlabel.open("data/Featureoutlabel.label");
...
ofstream foutfinal;
	foutfinal.open("tmp/foutfinal.txt");
...
ofstream fout;
    fout.open("tmp/myconfidence.txt");


ifstream fin;
	fin.open("tmp/testback.label");
