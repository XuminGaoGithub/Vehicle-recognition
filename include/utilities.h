...
using namespace std;
//using namespace boost::numeric::ublas;	// <-- added by zeeshan, may create some problem
...
void dispMatrix(const boost::numeric::ublas::matrix<float>& inMat);
void dispMatrix(const boost::numeric::ublas::matrix<float>& inMat, const int rowIndex);
