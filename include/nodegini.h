...
class NodeGini : public Node
{
 public:
    ...
    NodeGini(const HyperParameters &hp, int depth);
    NodeGini(const HyperParameters &hp, int depth, int reset);
    NodeGini(const HyperParameters &hp, int reset, const xmlNodePtr nodeNode);
