...
public:
    ...
    virtual xmlNodePtr save(FILE *fp) const = 0;
...
//    bool m_visited;
    Ptr m_parent;	// the following are added by Zeeshan, and used during writing the forest to the disk
    bool m_child_of_root;
    bool m_left_child;
};
